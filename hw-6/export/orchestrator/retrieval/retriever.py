...
class Retriever:
    ...
    async def get_context(
        ...
        # NOTE: The following code is commented out because we don't have access to:
        # - Embedding models (OpenAI API key or local embedding service)
        # - Search tools (Google API key or other search APIs)
        # This prevents the full RAG pipeline from working, so we return mock context instead
        ...
        yield {"event": "context", "data": "mock context"}
